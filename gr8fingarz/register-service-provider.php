...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		   <h4 class="page-title">Register Service Provider</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Service Provider</a></li>
            <li class="breadcrumb-item active" aria-current="page">Register Service Provider</li>
         </ol>
	   </div>
    ...
    <!-- End Breadcrumb-->
		 ...
		 <div class="row">
											<div class="col-md-12">
                                            <?php
 include("web-include/sp-registeration.php");
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Service Provider Information:</div>
             <div class="card-body">
				  ...
				  <div class="form-group overflow-hidden">
													<label>Email:</label>
 <input type="email" class="form-control" id="exampleInputuname_1" placeholder="Email Address" name="email" value="<?php 	 if(isset($_GET['value']))
	 { echo $email; } ?>" required>
												</div>
				 
				 <div class="form-group overflow-hidden">
													<label>First Name:</label>
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="First Name" name="fname" value="<?php 	 if(isset($_GET['value']))
	 { echo $fname; } ?>" required>
												</div>
 ...
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="Last Name" name="lname" value="<?php 	 if(isset($_GET['value']))
	 { echo $lname; } ?>" required>
												</div>
 ...
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="Phone (e.g. 080000909090)" name="phone" value="<?php 	 if(isset($_GET['value']))
	 { echo $phone; } ?>" required>
												</div>
 ...
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="Company's Name" name="cname" value="<?php 	 if(isset($_GET['value']))
	 { echo $cname; } ?>" required>
												</div>                          
          ...
          <div class="card">
            <div class="card-header text-uppercase"></div>
             <div class="card-body">
				  ...
				  <div class="form-group overflow-hidden">
													<label>Country:</label>
 <select class="form-control single-select" name="country" required>
 ...
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="House Number and street name" name="address1" value="<?php 	 if(isset($_GET['value']))
	 { echo $address1; } ?>" required>
												</div>
											   
				 
				 <div class="form-group overflow-hidden">
													<label>Land Marks:</label>
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="Near Gr8fingers Complex" name="address2" value="<?php 	 if(isset($_GET['value']))
	 { echo $address2; } ?>" required>
												</div>
				 
				 
				  <div class="form-group overflow-hidden">
													<label>City/Town:</label>
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="Ibadan" name="city" value="<?php 	 if(isset($_GET['value']))
	 { echo $city; } ?>" required>
												</div>
				 
				 <div class="form-group overflow-hidden">
													<label>State:</label>
<select class="form-control single-select" name="states"  required>
