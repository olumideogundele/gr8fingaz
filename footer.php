				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<div class="collapse dont-collapse-sm" id="collapse_ft_4">
						<div id="newsletter">
							...
							<form method="post" action="backend/assets/newsletter.php" name="newsletter_form" id="newsletter_form">
		...
		<form>
			<div class="sign-in-wrapper">
				...
				<div class="text-center">
					Don’t have an account? <a href="backend/register.html">Sign up</a>
				</div>
				<div id="forgot_pw">
					<div class="form-group">
