...
?>
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="../backend/admin_section/messages.html">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="../backend/admin_section/reviews.html">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="../backend/admin_section/bookings.html">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-danger o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="../backend/admin_section/bookmarks.html">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="../restricted/web-include/logout-2.php">Logout</a>
          </div>
        </div>
      </div>
    </div>
    <!-- Bootstrap core JavaScript-->
    <script src="../backend/admin_section/vendor/jquery/jquery.min.js"Dashboard></script>
    ...
    <script src="../backend/admin_section/vendor/chart.js/Chart.js"></script>
    ...
    <script src="../backend/admin_section/js/admin-charts.js"></script>
