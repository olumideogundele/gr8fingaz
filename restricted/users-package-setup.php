...
include("web-include/view-application-details-full.php");
 include("web-include/users-view-investment-details-all.php");
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
		 ...
		 <div class="row">
											<div class="col-md-12">
                                            <?php
											include("web-include/users-setup-investment.php");
            ...
            <div class="card-header text-uppercase">--</div>
             <div class="card-body">
               ...
               <thead>
                ...
                <tbody>
												   <?php
												include("web-include/users-view-investment-setup.php");
