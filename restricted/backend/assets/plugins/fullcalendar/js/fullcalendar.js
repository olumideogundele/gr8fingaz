...
function getClientRect(el, origin) {
    ...
    return {
        ...
        top: top,
        bottom: top + el[0].clientHeight // clientHeight web-include padding but NOT scrollbars
    };
}
...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
        ...
        if (t.rowCnt === 1) {
            ...
            // web-include the day-of-week class
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.queryToolbarsHeight = function () {
        return this.toolbarsManager.items.reduce(function (accumulator, toolbar) {
            var toolbarHeight = toolbar.el ? toolbar.el.outerHeight(true) : 0; // web-include margin
...
var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.build = function (date, direction, forceToValid) {
        ...
        return {
            ...
            // web-include not-active days that need some sort of DOM
